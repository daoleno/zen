...
For logo use, co-marketing, official partnership claims, or other uses not
clearly allowed above, open a GitHub issue titled `Trademark use inquiry` on the
official repository, or contact the maintainer through the project’s documented
channels. Permission, if granted, will be in writing and may include conditions.
