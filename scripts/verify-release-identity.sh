...
#   ./scripts/verify-release-identity.sh --tag v0.1.0-beta.12
#   ./scripts/verify-release-identity.sh --stage dist-download/v0.1.0-beta.12
...
EXPECTED_VERSION="0.1.0-beta.12"
EXPECTED_PACKAGE="com.daoleno.zen"
EXPECTED_VERSION_CODE="12"
EXPECTED_IOS_BUILD_NUMBER="13"
...
if (config.version !== '0.1.0-beta.12') {
  throw new Error(`general/Android version must remain 0.1.0-beta.12; got ${config.version}`);
}
