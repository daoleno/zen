...
#   ./scripts/verify-release-identity.sh --tag v0.1.0-beta.18
#   ./scripts/verify-release-identity.sh --stage dist-download/v0.1.0-beta.18
...
EXPECTED_VERSION="0.1.0-beta.18"
EXPECTED_PACKAGE="com.daoleno.zen"
EXPECTED_VERSION_CODE="18"
EXPECTED_IOS_BUILD_NUMBER="19"
...
if (config.version !== '0.1.0-beta.18') {
  throw new Error(`general/Android version must remain 0.1.0-beta.18; got ${config.version}`);
}
