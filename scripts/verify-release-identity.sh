...
#   ./scripts/verify-release-identity.sh --tag v0.1.0-beta.14
#   ./scripts/verify-release-identity.sh --stage dist-download/v0.1.0-beta.14
...
EXPECTED_VERSION="0.1.0-beta.14"
EXPECTED_PACKAGE="com.daoleno.zen"
EXPECTED_VERSION_CODE="14"
EXPECTED_IOS_BUILD_NUMBER="15"
...
if (config.version !== '0.1.0-beta.14') {
  throw new Error(`general/Android version must remain 0.1.0-beta.14; got ${config.version}`);
}
