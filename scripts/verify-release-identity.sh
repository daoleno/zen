...
#   ./scripts/verify-release-identity.sh --tag v0.1.0-beta.19
#   ./scripts/verify-release-identity.sh --stage dist-download/v0.1.0-beta.19
...
EXPECTED_VERSION="0.1.0-beta.19"
EXPECTED_PACKAGE="com.daoleno.zen"
EXPECTED_VERSION_CODE="19"
EXPECTED_IOS_BUILD_NUMBER="20"
...
if (config.version !== '0.1.0-beta.19') {
  throw new Error(`general/Android version must remain 0.1.0-beta.19; got ${config.version}`);
}
