...
#   ./scripts/verify-release-identity.sh --tag v0.1.6
#   ./scripts/verify-release-identity.sh --stage dist-download/v0.1.6
...
EXPECTED_VERSION_CODE="30"
EXPECTED_IOS_BUILD_NUMBER="28"
