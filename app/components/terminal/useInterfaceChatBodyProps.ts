...
export function useInterfaceChatBodyProps({
  ...
  return useMemo(
    () => ({
      ...
      onTimelineAnchorChange: timeline.handleTimelineAnchorChange,
      onTimelineAnchorLayout: timeline.handleTimelineAnchorLayout,
    ...
    [
      ...
      timeline.handleTimelineAnchorChange,
      timeline.handleTimelineAnchorLayout,
