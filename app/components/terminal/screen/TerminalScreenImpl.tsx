...
export default function TerminalScreen() {
  ...
  const { overlayProps, topBarProps, viewportProps } =
    useTerminalScreenLayoutProps({
      ...
      routeSheetEffortContract: routeSheet.effortContract,
      routeSheetEffortChoice: routeSheet.effortChoice,
      routeSheetEffortDisabled: routeSheet.activating,
      routeSheetHandoffWarning: routeSheet.handoffWarning,
      onRouteSheetEffortChange: (value) => routeSheet.selectEffort(value),
      createDurabilityWarning,
