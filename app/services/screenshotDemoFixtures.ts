...
export const SCREENSHOT_STATS_FIXTURE = {
  ranges: {
    all: {
      cost: 19.385618,
      costKnown: true,
      totalTokens: 297_724_978,
      totalTokensKnown: true,
      inputTokens: 4_458_105,
      outputTokens: 1_168_491,
      reasoningTokens: 924_940,
      cacheRead: 340_868_448,
      cacheCreate: 120_000,
      ...
      models: [
        ...
        {
          // Real daemon payload row for the local OpenCode account (captured
          // live 2026-08-07): requests, tokens, and exact recorded cost.
          name: "deepseek-v4-flash",
          totalTokens: 338_656_294,
          totalTokensKnown: true,
          inputTokens: 2_985_086,
          outputTokens: 631_818,
          reasoningTokens: 667_554,
          cacheRead: 336_398_336,
          cacheCreate: 0,
          tokenBreakdownKnown: true,
          cost: 0.965618,
          costKnown: true,
        ...
        {
          name: "kimi-k2.5-free",
          totalTokens: 4_179_180,
          totalTokensKnown: true,
          inputTokens: 233_019,
          outputTokens: 18_647,
          reasoningTokens: 7_386,
          cacheRead: 3_920_128,
          cacheCreate: 0,
          tokenBreakdownKnown: true,
          cost: 0,
