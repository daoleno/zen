...
//  5. claim one fair pending Work key at the boundary
...
// handling, pending user admission, and live foreground turn gates all stop
// the lane before any claim, in that order.
