...
This beta contains the reviewed changes on `main` since `v0.1.0-beta.17`.

## What changed

- Restore Composer Model-only boundary; Settings owns Provider switching (`346b6ba`)
- Clean stale Provider+Model comments on the Model-only Composer chip (`a3b08b8`)
