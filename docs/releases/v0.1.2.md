...
This release contains the reviewed changes on `main` since `v0.1.0-beta.22`.

## What changed

- Hide empty tool activity rows (`d1872f6`)
- Improve Brain, uploads, and Telegram integration (`177dbd8`)
- Improve Android LAN attachment uploads (`d8ebb28`)
- Fix Composer keyboard lifecycle ownership (`c566aeb`)
- Stream Android file downloads natively (`619a6bd`)
- Support stable Zen releases (`c1db083`)
