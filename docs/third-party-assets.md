...
| `meditation-ambient.m4a` | First-party procedural pad | Zen | Product license (same as Zen source) | Quiet Mode meditation bed. Regenerated by [`scripts/generate-meditation-ambient.sh`](../scripts/generate-meditation-ambient.sh). |
